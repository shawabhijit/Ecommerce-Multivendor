...
import { fetchSellerByEmail } from "../../app/seller/SellerSlice"
...
export function SellerLogin() {
    const dispatch = useAppDispatch()
        ...
        const onSubmit = async (data: FormData) => {
            ...
            try {
                const customer = await dispatch(fetchSellerByEmail(email))
                ...
                const res = await dispatch(sellerLogin({email,otp}))
